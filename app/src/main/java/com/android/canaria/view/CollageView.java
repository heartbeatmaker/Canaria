package com.android.canaria.view;
...
import com.android.canaria.view.RectangleImageView;
...
//                                        requestBuilder = requestManager.load(resId);
                                    }
                                } else {
                                    if (url != null) {
...
//                                        requestBuilder = requestManager.load(url);
                                ...
                                if (maxWidth != -1) {
                                    ...
                                    requestCreator
                                            .resize(30, 30); //이 사이즈가 작으면 사진 화질이 나빠진다
//                                            .onlyScaleDown();
...
//                                        options = RequestOptions.placeholderOf(placeHolderResId);
